// Article database for the SVarticles research page.
// Schema and classification rules are documented in CLAUDE.md.
...
// Sample records showing the expected shape — replace/remove these once real
// articles are added. Each one demonstrates a different primary bucket.
const ARTICLES = [
  {
    id: "2026-07-10-fed-rate-path-2026",
    title: "Fed signals slower pace of cuts through year-end",
    url: "https://example.com/fed-rate-path-2026",
    source: "Reuters",
    slackChannel: "#markets-macro",
    sender: "Dana K.",
    ...
    openQuestions: [
      "How does this change our underwriting assumptions for late-stage deals this quarter?"
    ],
    myNotes: "",
    relatedArticleIds: [],
  ...
  {
    id: "2026-07-11-ramp-ai-underwriting",
    title: "Ramp launches AI-driven underwriting for SMB credit lines",
    url: "https://example.com/ramp-ai-underwriting",
    source: "TechCrunch",
    slackChannel: "#fintech-deals",
    sender: "Priya S.",
    ...
    openQuestions: [
      "Does our target's data access rival Ramp's transaction-level visibility?",
      "How defensible is this once every card issuer offers something similar?"
    ],
    myNotes: "",
    relatedArticleIds: [],
  ...
  {
    id: "2026-07-12-portco-vitable-launch",
    title: "Vitable Health expands into employer-sponsored primary care",
    url: "https://example.com/vitable-employer-primary-care",
    source: "Company blog",
    slackChannel: "#portfolio-updates",
    sender: "Marcus T. (Vitable CEO)",
    ...
    openQuestions: [
      "What's the expected CAC/LTV in the employer channel vs. direct-to-consumer?",
      "Any channel conflict risk with existing D2C members?"
    ],
    myNotes: "",
    relatedArticleIds: [],
  ...
  {
    id: "2026-07-13-gig-work-regulation-eu",
    title: "EU finalizes platform worker classification rules",
    url: "https://example.com/eu-gig-work-rules",
    source: "Bloomberg",
    slackChannel: "#workforce-sector",
    sender: "Alex R.",
    ...
    openQuestions: [
      "Which of our workforce-sector targets/portfolio companies have EU exposure?"
    ],
    myNotes: "",
    relatedArticleIds: [],
